...
params.inputreads = "$baseDir/../../../disk2/ASE_Data/RNAseqData/*_R{1,2}.clean.fastq.gz"
...
workflow {
   ...
   readCounter(fasta_ch.collect(),fai_ch.collect(),dict_ch.collect(), indexvcf_ASE.out.vcf.collect().join(indexvcf_ASE.out.vcf_index.collect()),markDuplicates.out.markDup_ch1.collect())
