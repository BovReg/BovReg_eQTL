...
nominal_trans_ch = params.trans_nominal
...
workflow TRANSeQTL {
   ...
   trans_eQTL_nominal(qtlmap_trans_geneCount.join(qtlmap_trans_transcriptCount).join(qtlmap_trans_spliceCount), nominal_trans_ch, threshold_trans_ch)
...
workflow {
    ...
    main:
        ...
        TRANSeQTL(genotypeStratificationPCA,genotype_input_ch,phenotypeTranscript_ch,phenotypeGene_ch,splicepcs_ch,phenotypeSplice_ch,ch_FDR_trans,phenotype_PCs_trans, nominal_trans_ch, threshold_trans_ch,permutations_trans_ch)
}